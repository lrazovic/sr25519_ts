import { EdwardsBasepointTable, LookupTable } from "./edwardsBasepointTable";
...
export const AFFINE_ODD_MULTIPLES_OF_BASEPOINT =
	LookupTable.FromArrayOfStringsInRadix36Form(
		oddMultiplesAffinePointsInStringRadix36Form,
	);

export const ED25519_BASEPOINT_TABLE_INNER: EdwardsBasepointTable =
	new EdwardsBasepointTable(
		ed25519BasepointLookupTablesInStringRadix36Form.map(
			LookupTable.FromArrayOfStringsInRadix36Form,
		),
	);
